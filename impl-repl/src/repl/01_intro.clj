...
;; All of the above, we could implement ourselves (if we knew how).
...
;; ---------- Control structures (special forms: do, if)
...
;; -------- some operations on compound data structures:
